...
// @public (undocumented)
export const arr: <S extends Schema<unknown>>(item: S) => ArraySchema<S>;
...
// @public
export const expectStable: <S extends Schema<unknown>>(schema: S, options?: MockOptions) => Infer<S>;
...
// @public
export const mock: <S extends Schema<unknown>>(schema: S, options?: MockOptions) => Infer<S>;

// @public
export const mockDataset: <S extends Schema<unknown>>(opts: DatasetOptions<S>) => Infer<S>[];
...
// @public (undocumented)
export const parse: <S extends Schema<unknown>>(schema: S, value: unknown) => Infer<S>;
...
// @public
export const replay: <S extends Schema<unknown>>(schema: S, options?: MockOptions) => Replay<S>;
...
// @public (undocumented)
export const safeParse: <S extends Schema<unknown>>(schema: S, value: unknown) => SafeParseResult<Infer<S>>;
...
// @public (undocumented)
export const tuple: <T extends readonly Schema<unknown>[]>(...items: T) => TupleSchema<T>;
...
// @public (undocumented)
export const union: <T extends readonly Schema<unknown>[]>(...options: T) => UnionSchema<T>;
